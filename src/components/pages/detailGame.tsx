            ...
            <div className="flex items-center gap-1.5 mt-1">
                {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                        <FontAwesomeIcon
                            icon={faStar}
                            className={`text-lg ${star <= value ? 'text-brand-gold drop-shadow-[0_0_5px_rgba(255,215,0,0.5)]' : 'text-slate-600'}`}
                        />
                    </button>
                ))}
    ...
    return (
        <div className="max-w-325 mx-auto px-8 py-8">
            ...
            <button
                ...
                className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors mb-6 text-sm select-none focus:outline-none"
            >
                            ...
                            {[
                                ...
                                <div key={i} className="flex flex-col gap-1.5">
                                    ...
                                    <div className="w-full bg-black/40 h-2 rounded-full overflow-hidden">
                                        <div
                                            className={`${aspect.color} h-full rounded-full transition-all duration-1000`}
                    ...
                    <div className="bg-space-card border border-space-border w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
                        ...
                        <div className="p-6 border-b border-white/10 flex justify-between items-center shrink-0">
                            ...
                            <button
                                ...
                                className="text-slate-400 hover:text-white text-xl font-bold cursor-pointer select-none focus:outline-none"
                            >
                                &times;
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleSubmitReview} className="p-6 overflow-y-auto flex-1 flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="bg-black/40 border border-white/10 rounded-lg py-2.5 px-4 text-slate-100 text-sm focus:outline-none focus:border-brand-purple transition-colors resize-none"
                                />
                            </div>
                            ...
                            <div className="flex justify-end gap-3 mt-4 border-t border-white/10 pt-4 shrink-0">
                                <button
                                    type="button"
                                    onClick={() => setIsModalOpen(false)}
                                    className="bg-white/10 hover:bg-white/5 border border-white/10 text-slate-300 hover:text-white px-5 py-2.5 rounded-lg text-sm transition-colors cursor-pointer select-none"
                                >
                                    Cancel
                                </button>
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="bg-linear-to-br from-brand-purple to-purple-700 hover:brightness-110 disabled:opacity-50 text-white font-header font-bold px-6 py-2.5 rounded-lg text-sm shadow-lg shadow-brand-purple/20 transition-all flex items-center gap-2 cursor-pointer select-none"
                                >
